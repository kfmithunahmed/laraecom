...
<section id="do_action">
    <div class="container">
        <div class="heading text-center">
            ...
            <p>Your order number is {{ Session::get('order_id') }} and total payable about is TAKA {{ Session::get('grand_total') }} </p>
            ...
            <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
                ...
                <input type="hidden" name="business" value="kfmithunahmed@gmail.com">
