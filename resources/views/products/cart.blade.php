            ...
            <table class="table table-condensed">
                <thead>
                    <tr class="cart_menu">
                        ...
                        <td class="description">Product Info</td>
                    ...
                    @foreach ($userCart as $cart)
                        <tr>
                            <td class="cart_product">
                                <a href=""><img style="width:80px !important;" src="{{ asset('images/backend_images/products/small/'.$cart->image) }}" alt=""></a>
                            </td>
