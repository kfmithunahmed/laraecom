...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="#">CMS Pages</a>
            <a href="#" class="current">Edit CMS Page</a>
        </div>
        <h1>CMS Pages</h1>
        <div class="msg">
            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form class="form-horizontal" method="post" action="{{ url('/admin/edit-cms-page/'.$cmsPage->id)}}" name="edit-cms-page" id="edit-cms-page" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <textarea class="form-control" id="summary-ckeditor" name="description">{{ $cmsPage->description }}</textarea>
                            </div>
                        </div>
                        <div class="control-group">
