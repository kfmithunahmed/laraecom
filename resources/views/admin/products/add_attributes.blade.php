...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="#">Products</a>
            <a href="#" class="current">Add Product Attributes</a>
        </div>
            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form class="form-horizontal" method="post" action="{{ url('/admin/add-attributes/'.$productDetails->id) }}" name="add_attributes" id="add_attributes" novalidate="novalidate" enctype="multipart/form-data">
                            @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td class="center">
                                            ...
                                            <a id="delProduct" rel="{{ $attribute->id }}" rel1="delete-attribute" href="javascript:" class="btn btn-danger deleteRecord">Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
