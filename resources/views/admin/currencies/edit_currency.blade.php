...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Edit Currency</a> <a href="#" class="current">Add Currency</a>
        </div>
        <h1>Edit Currency</h1>
        <div class="msg">
            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form class="form-horizontal" method="post" action="{{ url('/admin/edit-currency/'.$currencyDetails->id)}}" name="edit_currency" id="edit_currency">
                        @csrf
